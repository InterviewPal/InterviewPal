...
export default function Navbar({ theme, onClick }: NavbarProps) {
    return (
        <div className="flex flex-row items-center justify-between w-full h-16 px-4 pt-2 md:px-24 md:pt-8">
            ...
            <div className="flex flex-row items-center justify-end ">
                <Link className="flex flex-row mr-8 text-xl md:text-2xl items-center justify-center text-rosePineDawn-text dark:text-rosePine-text font-display font-semibold" href="/#about">
                    About
                </Link>
