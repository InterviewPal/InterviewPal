    ...
    return (
        <>
            ...
            <main>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4 mx-auto text-rosePineDawn-text dark:text-rosePineMoon-text w-5/6">
