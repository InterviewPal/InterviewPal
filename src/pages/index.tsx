            ...
            <main className="text-rosePineDawn-text dark:text-rosePine-text pt-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4 mx-auto w-5/6">
                    ...
                    <div className="flex flex-col items-center justify-center pb-24">
                        <p className="text-xl text-center py-4">We are proud to introduce InterviewPal, an innovative app that leverages the power of AI to help job seekers prepare for interviews. In recent years, the job market has become increasingly competitive, with a fluctuating workforce further impacted by the COVID-19 pandemic. With so many qualified candidates and limited job opportunities, it can be challenging for job seekers to showcase their skills effectively and navigate interviews. That&apos;s where InterviewPal comes in.</p>
                        <p className="text-xl text-center py-4">Our app lets you practice answering common interview questions, refining communication skills and building confidence. With the help of GPT 3.5, our app analyzes a user&apos;s responses and provides personalized feedback.</p>
                        <p className="text-xl text-center py-4">We believe that InterviewPal has the potential to be a game-changer for job seekers in this challenging job market. By providing a powerful tool to practice and refine interview skills, we hope to help more people land their dream jobs.</p>
                    </div>
                </div>
